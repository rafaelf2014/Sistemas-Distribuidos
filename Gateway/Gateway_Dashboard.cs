...
partial class Gateway
{
    ...
    private readonly List<string> _alarmesEsquerda = new();
    private readonly List<string> _logsEsquerda    = new();
    private readonly List<string> _logsDireita     = new();
    ...
    void RegistarLogEsquerda(string mensagem, bool isAlarm = false)
    {
        lock (_consoleLock)
        {
    ...
    void RegistarLogDireita(string msgEnvio, string msgResposta)
    {
        lock (_consoleLock)
        {

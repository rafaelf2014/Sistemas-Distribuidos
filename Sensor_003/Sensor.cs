...
namespace sensor
{
    ...
    class Program
    {
        ...
        static void GerarEEnviarDado(SensorConfig cfg)
        {
            ...
            // CORREÇÃO: Probabilidade implícita! Se for RUIDO varia de 0 a 50, se HUM varia de 0 a 100.
            if (cfg.TipoDado == "RUIDO") valorGerado = r.NextDouble() * 120.0;
